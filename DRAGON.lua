...
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE spider.lua \e[0m"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./spider.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/soteem/soteem/main/DRAGON.lua')
os.execute('cd File_Bot && wget https://raw.githubusercontent.com/soteem/soteem/main/File_Bot/Reply.lua')
os.execute('cd File_Bot && wget https://raw.githubusercontent.com/soteem/soteem/main/File_Bot/games.lua')
os.execute('cd File_Bot && wget https://raw.githubusercontent.com/soteem/soteem/main/File_Bot/anamen.lua')
os.execute('cd File_Bot && wget https://raw.githubusercontent.com/soteem/soteem/main/File_Bot/commands.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/soteem/soteem/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/soteem/soteem/main/File_Bot/"..file)
if res == 200 then
...
if text == "مسح رد للكل" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == ("مسح ردود الجروب") and Manager(msg) then
...
send(msg.chat_id_, msg.id_,"℘︙تم مسح ردود الجروب")
end
if text == ("ردود الجروب") and Manager(msg) then
local list = database:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = "℘︙قائمه ردود الجروب \nٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'نعم يا روحي ❤')
...
if text == 'تفعيل ردود الجروب' and Manager(msg) then   
if database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
Text = ' ℘︙ تم تفعيل ردود الجروب'
...
if text == 'تعطيل ردود الجروب' and Manager(msg) then  
if not database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
database:set(bot_id..'Reply:Manager'..msg.chat_id_,true)  
Text = '\n ℘︙ تم تعطيل ردود الجروب' 
else
Text = '\n ℘︙ بالتاكيد تم تعطيل ردود الجروب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == 'رابط المسح' or text == 'رابط مسح' then
t =[[
رابط المسح في جميع مواقع التواصل ℘
